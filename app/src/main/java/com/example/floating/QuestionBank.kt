...
object QuestionBank {
    ...
    private fun generateAdvancedMathQuestion(typeIdx: Int = -1): Pair<Question, String> {
        ...
        24 -> { val shapes = listOf(Pair("正方体", "6"), Pair("三棱柱", "5"), Pair("圆锥", "2"), Pair("球", "1")); val s = shapes.random(); createQuestion("${s.first}有几个面？", s.second, listOf("2", "3", "4", "5", "6", "8").filter { it != s.second }.take(3)) }
